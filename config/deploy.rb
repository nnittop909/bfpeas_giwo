...
set :shared_files, fetch(:shared_files, []).push('config/database.yml', 'config/secrets.yml', 'config/master.key', 'config/puma.rb')
# Optional settings:
...
task :setup => :remote_environment do
  ...
  comment  %[echo "-----> Be sure to edit '#{fetch(:shared_path)}/config/database.yml', 'master.key' and 'secrets.yml'."]
